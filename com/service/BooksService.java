...
public class BooksService {
    ...
    public void AddBooksInfo(String s) {
        try {
            boolean flag = true;
            while (flag) {
                InputLimit.PurpleFont("请输入你要添加的图书名称:");
    ...
    public void QueryBookInfoByBookName() {
        ...
        InputLimit.PurpleFont("是否根据图书名称查询单个信息？（Y/N）");
        char c = TSUtility.readConfirmSelection();
        if (c == 'Y') {
            boolean flag = true;
            while (flag) {
                InputLimit.PurpleFont("请输入你要查询的图书信息的名称:");
            ...
            while (flag) {
                ...
                if (booksInfo == null) {
                    ...
                    if (b1) {
                        ...
                        String publish = TSUtility.readString(4, booksInfo.getPublish());
    ...
    public void DeleteBooksInfo(String s) {
        ...
        if (booksInfo == null) {
            ...
            String isbn = booksInfo.getISBN();
            boolean noISBN = new BorrowReturnDAO().HasBookByISBN(isbn);
